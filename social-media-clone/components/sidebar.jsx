...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full border-r border-gray-400 pr-0 xl:pr-8">
      <div className="flex items-center justify-center w-14 h-14 hover:cursor-pointer p-0 xl:ml-24">
        <FaXTwitter className="text-white text-[34px]" />
      </div>
      ...
      <div
        className="text-[#d9d9d9] flex items-center justify-center mt-auto hover:cursor-pointer xl:ml-auto xl:-mr-5 px-4 py-2"
        onClick={signOut}
      >
        <img
